...
<form id="menu-save" method="post" action="<?= url('editor/menu-save.php') ?>">
...
<!-- Menu item template -->
<?php include __DIR__ . '/_partials/menu-editor-templates.php'; ?>
<script type="module" src="<?= url('editor/_assets/menu-editor.js') ?>"></script>
...
<script>
    ...
    if (deleteBtn) {
        deleteBtn.addEventListener('click', () => {
            ...
            window.location.href = "<?= url('editor/menu-remove.php') ?>?menu=" + encodeURIComponent(menu);
        });
    }
</script>
